...
public class Test {
    static DiccionarioAVL avl = new DiccionarioAVL();
    static String ok="OK!",error="ERROR!";
  
    public static void main(String[] args) {
    
        System.out.println("TEST AVL");
        System.out.println("INSERTANDO  20 :"+respuesta(avl.insertar(parser("20"), null)));
        System.out.println("INSERTANDO  10 :"+respuesta(avl.insertar(parser("10"), null)));
        System.out.println("INSERTANDO  30 :"+respuesta(avl.insertar(parser("30"), null)));
        System.out.println("INSERTANDO  15 :"+respuesta(avl.insertar(parser("15"), null)));
        System.out.println("INSERTANDO  25 :"+respuesta(avl.insertar(parser("25"), null)));


        System.out.println(" APLICANDO ROTACION DERECHA INZQUIERDA CON 12 "+respuesta(avl.insertar(parser("12"), null)));
        ...
        System.out.println("INSERTANDO  11 :"+respuesta(avl.insertar(parser("11"), null)));
        System.out.println("INSERTANDO  5 :"+respuesta(avl.insertar(parser("5"), null)));
        System.out.println(avl.toString());
        
        System.out.println(" APLICANDO ROTACION DERECHA CON 23 "+respuesta(avl.insertar(parser("23"), null)));
        System.out.println("ARBOL ESPERADO :");
        ...
        System.out.println(" APLICANDO ROTACION DERECHA CON 3 "+respuesta(avl.insertar(parser("3"), null)));
        System.out.println("ARBOL ESPERADO :");
        ...
        System.out.println("INSERTANDO  26 :"+respuesta(avl.insertar(parser("26"), null)));
        
        System.out.println(" APLICANDO ROTACION IZQUIERDA DERECHA CON 27 "+respuesta(avl.insertar(parser("27"), null)));
        System.out.println("ARBOL ESPERADO :");
        System.out.println("RAIZ : 20 HI: 10 HD: 25");
        System.out.println("RAIZ : 10 HI: 5 HD: 12");
        System.out.println("RAIZ : 5 HI: 3" );
        ...
        System.out.println(" PROBANDO INSERTAR DUPLICADO 20 debe dar error "+ respuesta(avl.insertar(parser("20"), null)));
